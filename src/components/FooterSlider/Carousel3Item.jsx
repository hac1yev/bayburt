...
import { images3 } from '../../assets/dummyApi/DummyImages';
...
const Carousel3Item = () => {
  ...
  const showPrevSet = useCallback(() => {
    const newIndex = (currentIndex - 1 + images3.length) % images3.length;
    setCurrentIndex(newIndex);
  }, [currentIndex]);

  const showNextSet = useCallback(() => {
    const newIndex = (currentIndex + 1) % images3.length;
    setCurrentIndex(newIndex);
  }, [currentIndex]);
