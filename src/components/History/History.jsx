    ...
    <div className="container">
        <div className='row justify-content-between leader-message-container'>
            <div className='col-lg-3 leader-message-first'>
                ...
                <Link onClick={() => window.scrollTo(0,0)} to='/about/history' className='mybtn text-center'>VIEW OUR TEAM</Link>
            </div>
            <div className="leader-message-inner col-lg-8">
                ...
                >
                    ...
                    işlerin başarıyla tamamlanması ve yeni işlerin alınması, zamanla taahhütlerindeki işlerin
                    büyümesini ve 30.03.1987 tarihinde Bayburt İnşaat Nak. San. ve Tic. Ltd. Şti. unvanı ile yeni 
                    firmanın kurulmasını sağlamıştır.
                </p>
            </div>
            {/*  */}
